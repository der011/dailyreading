...
public class DateUtils {
   ...
   /**
    ...
    /**
     * Adds the to date specified amount of units.
     *
     * @param date the current date date
     * @param unittoAdd the (days, hours, months, years, whatever, eg. Calendar.HOUR)
     * @param amount the amount
     * @return the new date
     */
    public static Date addToDate(Date date, int unitToAdd, int amount) {
        Calendar cal = Calendar.getInstance();
        cal.setTimeInMillis(date.getTime());
        cal.add(unitToAdd, amount);
        return cal.getTime();
    }
    ...
    public static boolean isToday(Date date) {
        ...
        actual.setTimeInMillis(date.getTime());
        
        Calendar today = Calendar.getInstance();
        return (today.get(Calendar.DAY_OF_MONTH) == actual.get(Calendar.DAY_OF_MONTH) && today.get(Calendar.MONTH) == actual.get(Calendar.MONTH) && today
                .get(Calendar.YEAR) == actual.get(Calendar.YEAR));
    }
